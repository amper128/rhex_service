				 ...
				 struct ieee80211_radiotap_header *radiotap_header, int max_length)
{
	...
	if (unlikely(iterator->bitmap_shifter & (1U << IEEE80211_RADIOTAP_EXT))) {
		while (le32_to_cpu(*((u32 *)iterator->arg)) & (1U << IEEE80211_RADIOTAP_EXT)) {
...
ieee80211_radiotap_iterator_next(struct ieee80211_radiotap_iterator *iterator)
{
	...
	while (iterator->arg_index < sizeof(rt_sizes)) {
		...
		pad = (((ulong)iterator->arg) - ((ulong)iterator->rtheader)) &
