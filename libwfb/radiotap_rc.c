...
int
ieee80211_radiotap_iterator_init_rc(struct ieee80211_radiotap_iterator *iterator,
...
static void
find_ns(struct ieee80211_radiotap_iterator *iterator, uint32_t oui, uint8_t subns)
{
	int i;
...
#ifdef RADIOTAP_SUPPORT_OVERRIDES
static int
find_override(struct ieee80211_radiotap_iterator *iterator, int *align, int *size)
{
	int i;
...
int
ieee80211_radiotap_iterator_next_rc(struct ieee80211_radiotap_iterator *iterator)
{
	while (1) {
		int hit = 0;
		...
		default:
			...
			if (find_override(iterator, &align, &size)) {
				...
				align =
				    iterator->current_namespace->align_size[iterator->_arg_index]
					.align;
				size = iterator->current_namespace->align_size[iterator->_arg_index]
					   .size;
			}
			if (!align) {
